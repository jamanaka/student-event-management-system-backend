...
OtpSchema.statics.createOTP = async function(email, purpose = 'registration', userId = null) {
  try {
...
OtpSchema.statics.validateOTP = async function(email, code, purpose = 'registration') {
  try {
