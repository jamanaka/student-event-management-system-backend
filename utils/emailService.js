        ...
        html: `
            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 10px;">
                ...
                <div style="padding: 30px;">
                    <h2 style="color: #333;">Hello ${userName || 'Student'}!</h2>
    ...
    eventApproved: (eventTitle, userName) => ({
        ...
        html: `
            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 10px;">
                ...
                <div style="padding: 30px;">
                    <h2 style="color: #333;">Great news, ${userName || 'Organizer'}!</h2>
                    <p style="color: #666; line-height: 1.6;">
    ...
    eventRejected: (eventTitle, userName, reason) => ({
        ...
        html: `
            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 10px;">
                ...
                <div style="padding: 30px;">
                    <h2 style="color: #333;">Hello ${userName || 'Organizer'},</h2>
                    <p style="color: #666; line-height: 1.6;">
    ...
    rsvpConfirmation: (eventTitle, eventDate, eventTime, userName) => ({
        ...
        html: `
            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 10px;">
                ...
                <div style="padding: 30px;">
                    <h2 style="color: #333;">See you there, ${userName || 'Student'}!</h2>
                    <p style="color: #666; line-height: 1.6;">
...
const sendEmail = async (options) => {
    try {
        const mailOptions = {
            from: process.env.EMAIL_FROM || 'Student Event System <noreply@studentevent.com>',
            to: options.to,
